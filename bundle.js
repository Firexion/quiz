  ...
  render: function() {
    return (
      React.createElement("div", {className: "progress"}, 
        React.createElement("div", {style: {width: this.props.progress + '%'}, className: "progress-bar progress-bar active", id: "progress", role: "progressbar", "aria-valuenow": "-1", "aria-valuemin": "0", "aria-valuemax": "100"})
      )
    );
  }
});
...
},{"./Answer.js":1,"react":166}],4:[function(require,module,exports){
var React = require('react');
...
var QuizApp = React.createClass({displayName: "QuizApp",
  ...
  render: function() {
    ...
    if (this.state.finished) {
      return (
        React.createElement("div", {className: "QuizApp"}, 
          React.createElement("h1", {id: "question-title"}, "Results"), 
          React.createElement(Progress, {progress: this.state.progress}), 
          React.createElement("h3", null, "Score: ", this.state.numCorrect / this.state.questions.length * 100, "%")
        )
      );
    } else {
      return (
...
},{"./Progress.js":2,"./Question.js":3,"react":166}],5:[function(require,module,exports){
